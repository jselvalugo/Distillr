  ...
  app.get("/api/export/template/:table", requireAuth, async (req, res) => {
    const TABLE_COLS: Record<string, { header: string; hint: string }[]> = {
      production: [
        ...
        { header: "spiritClass",           hint: "e.g. Dark Rum, White Rum" },
        { header: "notes",                 hint: "free text" },
        { header: "distillDate",           hint: "YYYY-MM-DD" },
        { header: "stillType",             hint: "pot | column | hybrid" },
        { header: "distillationProof",     hint: "numeric — max 190" },
        { header: "proofGallonsProduced",  hint: "numeric — wine gal × proof / 100" },
        { header: "fillNumber",            hint: "TTB fill number / container ID" },
        { header: "containerType",         hint: "new_oak_barrel | used_barrel | tank | other" },
        { header: "fillDate",              hint: "YYYY-MM-DD" },
        { header: "fillProof",             hint: "numeric" },
        { header: "fillWineGallons",       hint: "numeric gallons" },
        { header: "fillProofGallons",      hint: "numeric — wine gal × fill proof / 100" },
        { header: "targetDumpDate",        hint: "YYYY-MM-DD" },
        { header: "amountReceivedGallons", hint: "numeric gallons received from dump" },
        { header: "bottlingDate",          hint: "YYYY-MM-DD" },
        { header: "lotNumber",             hint: "for label compliance" },
        { header: "bottlingProof",         hint: "numeric e.g. 90.0" },
        { header: "wineGallonsBottled",    hint: "numeric" },
        { header: "proofGallonsProcessed", hint: "numeric" },
        { header: "cases750ml",            hint: "integer" },
        { header: "cases1000ml",           hint: "integer" },
        { header: "cases1750ml",           hint: "integer" },
        { header: "totalCases",            hint: "integer" },
